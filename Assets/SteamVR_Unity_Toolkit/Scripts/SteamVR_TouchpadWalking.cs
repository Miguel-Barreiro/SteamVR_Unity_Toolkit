...
public class SteamVR_TouchpadWalking : MonoBehaviour {
    ...
    {
        //GameObject.FindObjectOfType<SteamVR_GameView>().GetComponent<Transform>();
        foreach(SteamVR_TrackedObject obj in GameObject.FindObjectsOfType<SteamVR_TrackedObject>())
        {
            if (obj.index.ToString().ToLower() == "hmd")
            {
